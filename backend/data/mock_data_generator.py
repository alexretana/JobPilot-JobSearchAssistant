...
try:
    from backend.api.leads_simple import Lead, LeadStatus, LeadType
...
class MockDataGenerator:
    ...
    def create_resume_generations(self, resume_ids: List[str]) -> List[str]:
        ...
        from backend.data.resume_models import ResumeFormat, ResumeGenerationDB
        ...
        with self._get_session() as session:
            for resume_id in resume_ids:
                ...
                from backend.data.resume_models import ResumeDB
    ...
    def create_resume_optimizations(
        ...
        from backend.data.resume_models import ResumeOptimizationDB
    ...
    def create_resume_versions(self, resume_ids: List[str]) -> List[str]:
        ...
        # Import required model
        from backend.data.resume_models import ResumeVersionDB
